 ...
 * in coordinate circles.ball.space, specified to integer precision.
 **/
public class Point implements Comparable<Point>{
     ...
     *  another Point in coordinate circles.ball.space.
     *  @param other point object.
    ...
    /**
     * 	returns the distance between the current Point to
     *  another Point listed construction.
    ...
    /**
     * 	changes the x location of the point in coordinate circles.ball.space to
    ...
    /**
     * 	changes the y location of the point in coordinate circles.ball.space to
     *  the location specified.
