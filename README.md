[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/qDpXtTYL)
# Start Here
Update All Code Submissions for CSC-143 (Winter 2026) here.

## This is the repository for Winter 2026 GitHub Projects/Labs.
...
## Coding Aesthetics
Aesthetics is key. Poor code styling will not be assessed favorably.

## Coding Style
Here are some things to note to improve your chances of having code submissions of reasonable quality
* braces should adhere to the default in IntelliJ
* vertical and horizontal white spaces are required throughout code.
...
* use descriptive identifier names that show the usage of the variable, method, reference etc.
...
* don’t repeat code that can be called from one place, remove redundant code.
